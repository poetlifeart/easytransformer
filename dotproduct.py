...
class ScaleDotProductAttention(nn.Module):
    ...
    def forward(self, queries ,keys, values, mask=None):
        ...
        args:
            ...
            number of heads, number of timesteps, and number of timesteps. The feature dimension is taken care of by
            broadcasting. The mask is a tensor with binary values where 0 indicates that the attention weights are not.
        """
        ...
        attention = (queries @ keys_transpose)/self.scale
